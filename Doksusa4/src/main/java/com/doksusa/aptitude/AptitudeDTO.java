...
public class AptitudeDTO {
	...
	public AptitudeDTO(int a_num, String a_school, int a_year, String a_subject, int a_subnum, int a_answer,
			String a_link, String a_title) {
		super();
		this.a_num = a_num;
	...
	public String toString() {
		return "AptitudeDTO [a_num=" + a_num + ", a_school=" + a_school + ", a_year=" + a_year + ", a_subject="
				+ a_subject + ", a_subnum=" + a_subnum + ", a_answer=" + a_answer + ", a_link=" + a_link + ", a_title="
				+ a_title + "]";
	}
